...
3. [Blueprinting the Operation](#blueprinting-the-operation)
4. [Deriving the Specification](#deriving-the-specification)
5. [Prior Art and Evaluation](#prior-art-and-evaluation)
6. [The Resulting Architecture](#the-resulting-architecture)
7. [Adoption Is an Architectural Constraint](#adoption-is-an-architectural-constraint)
8. [From Visibility to Prediction](#from-visibility-to-prediction)
9. [Results](#results)
10. [Known Considerations](#known-considerations)
11. [Why the Method Survives Procurement](#why-the-method-survives-procurement)
12. [What Would Change Today](#what-would-change-today)
