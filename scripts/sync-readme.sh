...
content="$(sed "s|](\\./Writing/README\\.md)|]($BASE/Writing/README.md)|g" <<< "$content")"
content="$(sed -E "s|]\\(\\./Writing/([^)#]+)\\)|]($BASE/Writing/\\1)|g" <<< "$content")"
...
content="$(sed -E "s|]\\(\\./White-Papers/([^)#]+)\\)|]($BASE/White-Papers/\\1)|g" <<< "$content")"
